...
const Color primaryColorLight = Color(0xFFFFBA6A);
...
const Color darkBrown = Color(0xFF784305);
const Color backGround = Color(0xFFFFF5EB);
const Color backGroundDark = Color(0xFFFFDBB1);
...
const Color silver = Color(0xFFBEBEBE);


const List<Color> colorsVer1 = [
  darkBrown,
  silver,
  silver,
  primaryColorLight,
